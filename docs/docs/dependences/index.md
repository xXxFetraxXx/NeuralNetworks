# NeuralNetworks Module test

Module complet pour faciliter la création et l'entraînement de modèles pytorch en fournissant des classes préconfigurés.
...
inhérite des propriétés de la classe [`Module`](#module)   
...
| **Paramètres**     | **Type**                                                                                        | **Optionnel** | **Description**                                                                                                 |
|--------------------|-------------------------------------------------------------------------------------------------|---------------|-----------------------------------------------------------------------------------------------------------------|
| `*nets`            | [`Module`](#module)                                                                                   | Non           | Réseaux pour lesquels le trainer va entrainer.                                                                  |
...
| **Paramètres** | **Type**                                                                       | **Optionnel** | **Description**                                                          |
|----------------|--------------------------------------------------------------------------------|---------------|--------------------------------------------------------------------------|
| `*nets`        | [`Module`](#module)                                                            | Non           | Réseaux pour lesquels afficher les résidus.                              |
...
| **Paramètres** | **Type**                                                                                 | **Optionnel** | **Description**                                    |
|----------------|------------------------------------------------------------------------------------------|---------------|----------------------------------------------------|
| `*nets`        | [`Module`](#module)                                                                      | Non           | Réseaux pour lesquels afficher les learning rates. |
